                            ...
                            <div className="space-y-3 md:col-span-3">
                                <div>
                                    <h3 className="text-2xl font-bold leading-8 tracking-tight">
                                        <Link href={`/blog/${article.article_id}`} legacyBehavior={true}>
                                            <a className="text-blue-900 dark:text-blue-900">
                                    ...
                                    <div className="mt-3 flex flex-wrap">
                                        {article.tags.map((tag) => (
                                            <Link key={tag.tag_id} href={`/tags/${tag.tag_name}`} legacyBehavior={true}>
